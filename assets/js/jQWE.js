...
$(document).ready(function() {
    ...
    $('#language-tab li a').click(function(){
        ...
        textarea = $("textarea#description\\["+lang+"\\]");
        container = textarea.closest("div.wysiwyg-container");
        
        $(".input-description-wide").children("div").each( function(index, element) {
            $(this).fadeOut("fast");
        });
        
        container.parent("div").fadeIn("fast");
    }); 
